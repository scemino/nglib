...
type
  ...
  ImGuiContext* {.importc: "ImGuiContext", imgui_header.} = object
    ...
    hoverDelayId* {.importc: "HoverDelayId".}: ImGuiID
    hoverDelayIdPreviousFrame* {.importc: "HoverDelayIdPreviousFrame".}: ImGuiID
    hoverDelayTimer* {.importc: "HoverDelayTimer".}: float32
    hoverDelayClearTimer* {.importc: "HoverDelayClearTimer".}: float32
    ...
    localizationTable* {.importc: "LocalizationTable".}: array[7, cstring]
...
proc igGetKeyOwnerData*(key: ImGuiKey): ptr ImGuiKeyOwnerData {.importc: "igGetKeyOwnerData".}
proc igGetKeyPressedAmount*(key: ImGuiKey, repeat_delay: float32, rate: float32): int32 {.importc: "igGetKeyPressedAmount".}
proc igGetKeyVector2dNonUDT*(pOut: ptr ImVec2, key_left: ImGuiKey, key_right: ImGuiKey, key_up: ImGuiKey, key_down: ImGuiKey): void {.importc: "igGetKeyVector2d".}
...
proc igImageButtonEx*(id: ImGuiID, texture_id: ImTextureID, size: ImVec2, uv0: ImVec2, uv1: ImVec2, bg_col: ImVec4, tint_col: ImVec4): bool {.importc: "igImageButtonEx".}
